...
export default function ShoppingCart() {
  ...
  return (
    <div className="lg:w-1/3 absolute z-10 p-2 right-0 lg:top-36 top-48 bg-gray-200 lg:border-l-2 lg:border-b-2 border-solid border-black rounded-bl-lg rounded-br-lg">
